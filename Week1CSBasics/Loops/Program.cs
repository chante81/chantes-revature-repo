...
int tommyTotal = 0;
        ...
        while (b > 0)
        {
            ...
            if (b < s)
            {
                steveTotal = steveTotal + b;
                b = b - b;
                Console.WriteLine($"Steve wins! His total is: {steveTotal}");
            }
            ...
            else
            {
                ...
                if (b < t)
                {
                    tommyTotal = tommyTotal + b;
                    b = b - b;
                    Console.WriteLine($"Tommy wins! His total is: {tommyTotal}");
                }
            }

        }
        System.Console.WriteLine($"Steve total: {steveTotal}");
        System.Console.WriteLine($"Tommy total: {tommyTotal}");
